...
if __name__ == '__main__':
    ...
    Accepts argparse arguments:
        --dataset: the dataset to use. Accepted: imdb. Default: imdb
        --n: the number of rows to use from the dataset. Default: 16
    ...
    args.add_argument('--dataset', default='imdb', help='the dataset to use. Accepted: imdb, squad. Default: imdb')
    args.add_argument('--n', default=32, type=int, help='the number of rows to use from the dataset. Default: 16')
    args.add_argument('--seed', default=0, type=int, help='the seed to use for the dataset. Default: 0')
    args.add_argument('--lm_model', default='EleutherAI/gpt-neo-2.7B', help='the language model to use. Supported models: \
        - GPT-3: \'gpt3-ada\', \'gpt3-babbage\', \'gpt3-curie\', \'gpt3-davinci\', \'ada\', \'babbage\', \'curie\', \'davinci\' \
        - GPT-2: \'gpt2\', \'gpt2-medium\', \'gpt2-large\', \'gpt2-xl\', \'distilgpt2\' \
        - GPT-J: \'EleutherAI/gpt-j-6B\' \
        - GPT-Neo: \'EleutherAI/gpt-neo-2.7B\', \'EleutherAI/gpt-neo-1.3B\', \'EleutherAI/gpt-neo-125M\' \
    ...
    if 'accuracy' in df.columns:
        ...
        mi_template_acc = agg_df.sort_values('accuracy', ascending=False).head(1)['accuracy'].values[0]
